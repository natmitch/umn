...
* As, with many datasets, the file does not include the header line. Use the below as a guide on the columns: "id,(1) title,url,isPaid,(4)price,(5)numSubscribers,(6)numReviews,numPublishedLectures,instructionalLevel,contentInfo,publishedTime"
